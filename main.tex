...
%3.Pop structure and diversity
%%
%Success or failure of ITN choice (@@ref), insecticide type (@@ref) %and genetically modified mosquitoes release may all depend on %%correctly predicting the response of the natural vector %populations to these perturbations.
%
%Increased sampling of natural populations, therefore, increases our %knowledge about  the pan-Africa distributions of medically %important traits that could be used to parameterise predictive %models.
%
%Analyses of Phase 2 genetic diversity and other demographic %investigations clearly elucidate the benefits of adding mosquito %populations to the Ag1000G public data resource.
%%

%%
%Additional sampling, novel to Ag1000G, reveals that ...not %allisland pops are the same. ...colonies appear very %different...something about tajD and selection...something about %IBD?

%4.
%Isolation by distance - how relates to IR/gene-drive
%% 



\subsection*{isolation by distance discussion + cas9}
...
%%
The movement of mosquitoes has been a long-standing question in malaria vector control -
%
can mosquitoes move their genes long geographical distances during a single lifetime or is long distance gene-flow trans-generational?
%
Understanding this aspect of basic biology is important for optimising many aspects vector control,for example gene-drive... 

%

...The expanded geographical sampling in Phase 2 allowed fine-scale analysis of how geographic distance between populations is related to genetic distance.
%
Our calculations of Wright's Neighborhood Size \cite{wright1946isolation}...
%
Talk about differences between species, changes in local neigbourhood size and then link in the cas9 results to finish.
%
...
\subsection*{PBO net deployment discussion}
%%
