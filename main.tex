...
%%
The expanded sampling of the phase 2 dataset allows analysis of fine-scale geographic differentiation among \textit{Anopheles} populations of both \textit{An. gambiae} and \textit{An. coluzzii}.
%
To assess how geographic distance relates to genetic differentiation we calculated Wright's "Neighbourhood Size" \cite{wright1946isolation} for \textit{An. gambiae} and \textit{An. coluzzii} in West Africa (Figure \ref{fig:ibd_fig}a).
%
