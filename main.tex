...
%
These findings are in agreement with conclusions made from a study using time-series analyses (collecting 40,000 mosquitoes over five years), that \textit{An. gambiae} migrates long distances to repopulate areas after dry seasons, where as \textit{An. coluzzii} aestivates \textit{in situ} \cite{dao2014}.
%
