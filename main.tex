...
%
Mosquitoes were collected from natural populations at 15
sampling sites in 8 African countries (Extended Data Fig. 1). Sampling locations,
dates, specimen collection methods and DNA extraction methods are given in
Supplementary Information 1.1. We also performed genetic crosses between adult
mosquitoes obtained from laboratory colonies (Supplementary Information 1.2).
Parents and progeny of four crosses were contributed to Ag1000G phase 1
(Extended Data Fig. 1). No statistical methods were used to predetermine sample
size.

here is a bit about how new collection sites for phase 2 are found in detail below
give total numbers for countries, locations, sites etc then link phase 1 paper...
