...
\subsection*{2.1 Sequence analysis and variant calling}

Sequencing pipelines were unchanged from phase 1 of the Anopheles 1000 genomes project\cite{Miles2017}.
%
...
\subsection*{2.2 Genome accessibility}
...
%
Following \cite{Ag1000gConsortium2017}, we applied the following SNP filters to reduce the number of false SNP discoveries.
%
We filtered any SNP that occurred at a genome position classified as inaccessible as described in the section on genome accessibility above, removing SNPs with evidence for excessively high or low coverage or ambiguous alignment. 
%
...
%
The 377 additional individuals in phase 2 result in >5 million more filter passing SNPS than in phase 1 \cite{Ag1000gConsortium2017}.
%
