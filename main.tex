...
%%%
TWO PARAGRAPHS HERE ABOUT AG1000G, WHAT WAS THE FIRST PHASE, WHAT IS THIS PHASE,
%%
...
%
Phase 1 of the project publicly released data from 765 wild caught Anopheles \cite{Ag1000gConsortium2017} which have already been used to address a wide-range of scientific questions regarding malaria control.
%
..crispr cas9, deep learning selections scans, ?modelling?, how complexity of copy number variation may hold the key to missing resistance variation...
%
...It has become evident that these dataset enabling genomic surveillance are essential to augment current vector control efforts, particularly if we are to become predictive rather than reactive in our management of insecticide resistance.
%%
