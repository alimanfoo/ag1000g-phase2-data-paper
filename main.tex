...
%%
Currently, the surveillance of insecticide resistance in natural vector populations in achieved via insecticide resistance testing of natural populations (e.g. WHO tube assay) and molecular (PCR/TaqMan) assays of known genetic resistance loci.
%
Measuring the resistance of live mosquitoes samples, bred from natural populations provides an almost real-time (one generation removed) picture of the strength of resistance and most insecticides (all?) can be tested with no prior knowledge of their resistance loci or mode of resistance.
%
However, this approach requires high levels of training/technique and environmentally controllable spaces (humidity/temperature/light) to enable the breeding of enough mosquitoes for testing .
%
Molecular assays conversely, can be quickly run on dead samples collected directly from natural populations without requirement for breeding the high numbers of mosquitoes necessary for tube assays plus reagents and equipment are relatively inexpensive. 
%
Unfortunately, the specificity of molecular assays, which can indicate which genetic loci which may contributing to resistance, is also restrictive as only known resistance markers can be tested.
%
Historically the development and validation of new molecular markers is slow (how many do we have in gambiae / how many years have we been looking), compounded by the high rates of insect adaptation that are found in response to insecticides.
%
It has become apparent that resistance testing and molecular techniques alone are unable to keep pace of resistance evolution (Donnelley 2016?) and if 
%
...
- molecular benefits and issues
- THE GENOMIC SOLUTION


%
Maybe have a more general malaria vector intro without details of Cas9/PBO?
%

%
\subsection*{Introduction Cas9}
%%
??.
%%
The spread of introduced genes will also be affected by the distances move during their lives.
%%

%%
\subsection*{Introduction Migration}
%%
??
%%
...
%%
%intro PBO nets
\subsection*{possible introduction on PBO}
%%
...
Intro outro. --
%%
Here, firstly we describe the population diversity and structure of the vector populations now publicly available as Phase 2 the of Ag1000G project, revealing the breadth of demography and evolutionary histories now represented in these data.
%
Next, we illustrate the power of this genomic resource to inform malaria eradication efforts.
%
Using the data set, we shed new light on three important questions in vector control: migration/estivation of mosquitoes, the introduction of next-generation cytochrome P450 synergist bed-nets and the development of gene-drive technologies. 
%%
