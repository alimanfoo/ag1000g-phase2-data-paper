...
%
In Phase 2 of the AG1000G Project we have sequenced the genomes of 1142 wild caught \emph{Anopheles} mosquitoes; 655 \textit{Anopheles gambiae} individuals, 283 \textit{An. coluzzii} and 204 individuals of undetermined species (individuals with apparent mixed or unclear ancestry).
%
...
%
The pericentromeric region of chromosome X is an exception to this, a known genomic region of divergence between the two species \cite{Ag1000gConsortium2017}, here the reference genome is more similar to \textit{An. coluzzii} than to \textit{An. gambiae}.
%
...
% 
Here we revisit population structure analyses to include the seven additional populations in Phase 2.
%%
...
%
The three \textit{An. coluzzii} populations, C\^{o}te d'Ivoire (CIcol), Guinea (GNcol) and Ghana (GHcol) (Figure \ref{sample_map}) are of particular importance to the Phase 2 data release.
%
...
%
This made general conclusions about the history and population structure of this major malaria vector problematic and the relationship to its sister species \textit{An. gambiae} difficult to investigate \cite{Ag1000gConsortium2017}.
%
Relative to Phase 1, less population structure is found between the the three additional Phase 2 \textit{An. coluzzii} populations.
%
