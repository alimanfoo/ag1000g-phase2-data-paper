...
%%
Target-site mutations are often used as a proxy for resistance to pyrethroids (@@REF), either due to the assumption that this mode of resistance is dominant or possibly due a lack of amplification markers for high-throughput study.
%
However, combining both target-site and amplified P450 loci in one pan-African analysis revealed several novel findings which may call into doubt the efficacy of the \textit{kdr} proxy.
%
...
%
A region showing particular concern for reliance upon target-site proxies of resistance is the Far West of Africa, Guinea Bissau and The Gambia.
%
These far-western populations may be considered pyrethroid susceptible as no \textit{kdr} mutations are found, despite carrying high frequencies of metabolic resistance markers (Figure \ref{ir})(@@REF e.g. Vincente?); a finding which highlights the importance of locating, understanding and developing high throughput assays for amplifications as part of malaria vector control efforts.
%%

%%
The pyrethroid resistance genotype analysis also highlights striking features of population structure (or lack thereof).
%
In countries where sampling covers sympatric \textit{An. gambiae} and \textit{An. coluzzii}, Burkina Faso and Ghana, we find similar profiles of resistance loci across species, reinforcing earlier findings of highly porous species boundaries where insecticide resistance is concerned (\cite{Ag1000gConsortium2017}, Clarkson et al, Lucas et al).
%
The mainland central/western populations appear to fall into three groupings of pyrethroid resistance loci, the Far-West as reported above where only P450 amplifications were found, western populations (Burkina Faso, Guinea, C\^{o}te d'Ivoire) where most individuals carry both \textit{kdr} and P450 amplification, and the more central population of Ghana, Gabon and Angola when target-site mutations are dominant.
%


2. 'species' in west africa
3. islands
4. East shared resistance haplotypes yet the profile by this measute looks different

. For indepth analyses of these data see Eric
