...
%%
Target-site mutations are often used as a proxy for resistance to pyrethroids (@@REF), either due to the assumption that this mode of resistance is dominant or possibly due a historical lack of amplification markers for high-throughput study (Lucas et al).
%
...
%
These may be considered pyrethroid susceptible as no \textit{kdr} mutations are found despite carrying high frequencies of metabolic resistance markers (Figure \ref{ir})(@@REF e.g. Vincente?); a finding which highlights the importance of locating, understanding and developing high throughput assays for amplifications as part of malaria vector control efforts.
%%

%%
The pyrethroid resistance genotype analysis also highlights striking features of population structure (or lack thereof).
%
In countries where sampling covers sympatric \textit{An. gambiae} and \textit{An. coluzzii}, Burkina Faso and Ghana, we find similar profiles of resistance loci across species, reinforcing recent findings of highly porous species boundaries where insecticide resistance is concerned (\cite{Ag1000gConsortium2017}, Clarkson et al, Lucas et al).
%
...
%
The majority of Ugandan mosquitoes sampled carried both \textit{kdr} and a P450 amplification whereas in Kenya there was only low frequencies of P450 amplifications.
%
...
%
A much deeper analyses of resistance associated gene amplification in the Phase 2 data can be found in Lucas et al 2019.
...
%%
IR 
1. WEST - porous geography and species boundaries - reinforces ag1000g/vgsc/Lucas
2. EAST - though kdr crossed the rift (ag1000g) - seems like P450 resistance isn't homogenous (why? - different ecology/control or perhaps more recent and has yet to reach Ugandan levels - though haplotype work (phase1) for CYP6 at least, shows there is no sharing across rift.
3. "...a finding which highlights the importance of locating, understanding and developing high throughput assays for amplifications as part of malaria vector control efforts." Particulary in the Far-West but applies generally.
4. - WHAT DOES THIS MEAN FOR PBO BEDNETS!!
%%
