...
%what is this data resource based on
%what is being released to public
%what kind of analyses these data enable


%IR
%what to improve
%what is coming in phase 3 and beyond.
...
%
\textbf{2.} Regions with both high target-site and high metabolic resistance associated loci frequencies, in these regions many individuals carry markers for both modes of resistance.
%
...
%
In order to extract the maximum value from genomic insecticide resistance monitoring, with which to inform NMCPs, we suggest a two stage approach.
%
...
%
Secondly, samples are collected regularly from sentinel sites across Africa, changes in frequencies of resistance associated loci can then be detected and this information can be quickly relayed to stakeholders to inform vector control programs.
%
...
...The third and final stage of Ag1000G Project, Phase 3, will release..
%
