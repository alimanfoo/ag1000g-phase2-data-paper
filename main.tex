...
%what is this data resource based on and what is being released to public
%%
Herein, we have briefly described Phase 2 of the Ag1000G Project, a data release consisting of deep-sequenced whole genome variation from 1142 wild caught \emph{Anopheles} mosquitoes.
%
Genomic variation and meta-data are now available to download from www.MalariaGen.net for 16 distinct populations of mosquitoes, sampled from 13 countries across Sub-Saharan Africa. 
%
We defined 61\% (140Mbp) of the genome to be accessible (where we confidenly call SNPs) and from these accessible regions we identified 57,837,885 high-quality SNPs, an average of one variant allele every 1.9 bases of accessible genome.
%
...
%%
These data have been released in analysis ready formats.
%
biallelic. 44,076,901
%
Whole genome phasing was performed for all samples.
%
analysis ready data - formats/meta-data/haplotypes/resistance typing - quickly and easy look at frequencies of ir loci by region etc/
%%
...
%%what kind of analyses these data enable
high level structure/pop gen - /ibd/cas9/ir 
%%
...
%%
It must be reiterated that these results, though informative, are a predication of pyrethroid resistance at the time of sample collection (Table \ref{table:sampling_locations}).
%
...
%
Firstly, sampling should be conducted on a wider geographic scale to cement understanding on population structure and diversity across sub-Saharan Africa, ensuring that genetically representative sentinel collection sites can be chosen and established.
%
...
%
This temporal genomic sampling also allows detection new loci potentially linked to resistance by monitoring changes in frequency of alleles across the whole genome.
%%
...
%
Expanding and improving these repositories with higher sampling coverage and faster data turn around can only strengthen the vector control armamentarium in the fight against malaria.
%%
