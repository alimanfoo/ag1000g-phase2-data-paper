...
%
Accessible regions of the genome are defined as regions in which we can confidently call SNPs which can then be used in analysis of population variation.
%
...
%
On the X chromosome the median was 3.3kb, but performance in the centromeric region was much higher- up to 30.8kbp.
%%
