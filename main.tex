...
%%
We combined the amplification data with data on nucleotide variation within the \textit{Vgsc} gene, the target for pyrethroids, to provide an estimate for the population frequencies of mosquitoes carrying some form of \textit{kdr} target-site pyrethroid resistance, amplifications at either of the two P450 loci, or both (Figure \ref{ir}). 
%
PBO impregnated nets may only offer benefits over traditional LLINs where metabolic resistance to pyrethroids are present.
%
Fortunately our analysis reveals several features of the pyrethroid resistance landscape that could determine the effectiveness of PBO bed-nets and therefore inform national malaria control programmes (NMCPs).
%%
...
%%
A P450 amplification frequency trend, and therefore potential impact of a PBO net over a traditional LLIN, may be noted across mainland West Africa populations from higher in the west to lower in the east \ref{ir}.
%
In the "Far-West" populations of Guinea Bissau and The Gambia (@@REF), no known \textit{kdr} mutations are detected, however many individuals carry P450 amplifications, suggesting PBO net roll-out may be highly advantageous here.
%
The individuals sampled from Burkina Faso and Guinea have high levels of \textit{kdr} mutations but also the highest frequencies of P450 amplifications, therefore the addition of PBO may increase the level of protection bed-nets provide.
%
Further east, in Ghana Gabon, Angola and Cameron populations, lower frequencies of P450 amplification alongside high \textit{kdr} frequencies, suggest the net gain of PBO inclusion may be small.
%
Eastern populations appear split by the rift valleys with Uganda presenting high frequencies of P450 mutations, and therefore the potential for PBO gains, whereas Kenya has almost no P450 amplification \ref{ir}.
%
...
IR
1.PBO discussion
--GOod, middling, pointless
--but just a snapshot - an analysis like this would need to be routinely run to keep NMCPs up to date.
- could be other insecticides + resistance OR it could be pyrethroid resistance but markers we haven't included yet e.g. on the islands.

2.assay discussion 
Due to the skill and equipment costs of insecticide resistance bio-assays, high throughput molecular assays of target-site mutations are often used as a proxy for resistance to pyrethroids in natural populations \textit{e.g.} \cite{pinto2006, wilson2018} but see \cite{donnelly2009}, and therefore may be used to inform NMCPs.
%
...
%
Our findings here also reveal how problematic this proxy may be with , particularly if the natural populations have not recently had any bio-assays conducted.
%
Two of the countries we sampled from show high frequency resistance associated P450 amplifications in the absence of \textit{kdr} target-site mutations.
%

...a finding which highlights the importance of locating, understanding and developing high throughput assays for amplifications as part of malaria vector control efforts.
