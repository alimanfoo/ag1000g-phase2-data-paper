...
%
An important question currently facing malaria vector control programmes concerns the procurement and deployment of "next-generation" LLINs which combine pyrethroid with a piperonyl butoxide (PBO) synergist which counteracts metabolic resistance caused by cytochrome P450 genes \cite{killeen2018, toe2018}.
%
...
%%
A P450 amplification frequency trend, and therefore a potential cline in the impact of a PBO net over a traditional LLIN, may be noted across mainland West African populations from higher in the west to lower in the east (Figure \ref{ir}).
%
...
%
Two of the countries we sampled from show high frequency resistance associated P450 amplifications in the absence of \textit{kdr} target-site mutations, these findings revealing how uninformative this proxy may be and further reinforce importance of locating, understanding and developing high-throughput assays for metabolic resistance amplifications (and other potential modes of insecticide resistance) as part of malaria vector control efforts.
%%
