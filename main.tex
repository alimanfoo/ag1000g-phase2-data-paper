...
%
This pattern has been repeated for over half a century as new first-line insecticides and antimalarials have been developed, deployed, then rendered ineffective by resistance in an evolutionary 'arms race'.
%
However, the last 15 years witnessed a change in fortunes, mass bed-net distributions and artemisin combination therapy (ACT) saw substantial gains with large reductions in malaria prevalence and morbidity \cite{Bhatt2015}.
%
2018 alone saw 172 million long-lasting insecticide treated nets (LLINs) distributed for free in sub-Saharan Africa (www./allianceformalariaprevention.com/net-mapping-project/).
%
Unfortunately these successes may be difficult to sustain, in recent years vector resistance to pyrethroid insecticides has become so widespread that there are now fears of control failure \cite{churcher2016, Hemingway2016} and ACT resistance is now prevalent in South East Asia and spreading fast (what is best Pf ref?).
%
With pyrethroids still currently used in all LLINs and no new anti-malarial drugs (?), it is clear that effective resistance surveillance is essential to maximise the impact and manage sustainability of national malaria control programs (NMCPs). 
%%
...
%
Measuring the insecticide susceptibility phenotypes of live mosquitoes samples, provides an almost real-time picture (perhaps just one generation removed) of the strength of resistance and insecticides can be tested with no prior knowledge about potential modes of resistance or of underlying causative genetic resistance loci.
%
...
%%
Molecular insecticide resistance assays can, conversely, be quickly run on dead samples collected directly from natural populations without requirement for breeding the high numbers of mosquitoes necessary for resistance assays.
%
Another advantage is that reagents and equipment are relatively inexpensive. 
%
Though the specificity of molecular assays is useful, as the actual genetic loci \textit{e.g.} single nucleotude polymorphism (SNP) or copy number variant (CNV) contributing to resistance can be indicated, is also restrictive, as this means only known resistance markers can be tested.
%
...
%
SOMETHING LIKE...need to find the missing variation...CNVs (ERIC)...fortunately large scale genome sequencing projects can help... 
%%
...
%
The project forms part of the Malaria Epidemiology Network (MalariaGen - www.malariagen.net) a community of data-sharing and researchers and investigating how genetic variation in humans, malaria parasite and malaria vectors affects can inform biology, epidemiology and ultimately global malaria control.
%
The output of Ag1000G include whole genome variation, phased haplotypes, meta data and results of scans for signatures of selection, all of which is free to analyse under MalariaGen's guiding principles on data sharing \cite{network2008, chokshi2006, parker2009}
%
Phase 1 of the project publicly released data from 765 wild caught Anopheles \cite{Ag1000gConsortium2017} which have already been used to address a wide-range of scientific questions regarding malaria control that would be difficult or impossible to pose without access to this kind of data repository.
%
These data have already been utilised to implement genome scans for signals of selection, highlighting new potential signals of insecticide resistance (Harding biorxiv),to develop new methods for selection scans using on deep-learning (Kern etc) and to identify genomic targets for CRISPR-Cas9 mediated gene drive vector control (Burt et al). 
%
@@Do we have anything from the modelling guys we can put it here?@@
%
Research into the understudied metabolic mode of insecticide resistance has also elucidated previously unknown complexity of copy number variation which may hold the key to the presently unaccounted for variation in levels of resistance \cite{lucas2019, mitchell2014} 
%
It has become evident that datasets which can be used to identify potential markers of resistance or improve the vector control 'genetic toolkit' are essential to augment current vector control efforts.
%
Genomic surveillance of natural populations 

if we are to become predictive rather than reactive in our management of insecticide resistance.
%%


%%
The pervasive increase in pyrethroid resistance detected across Sub-Saharan Africa is raising fears of LLIN failures leading to increases in malaria morbidity and morbidity \cite{churcher2016, Hemingway2016}.
%
...
%
An important question, therefore, can we predict where PBO net distribution could most impact vector populations and conversely, where there is no benefit over traditional LLINs \cite{protopopoff2018, toe2018}.
%%
