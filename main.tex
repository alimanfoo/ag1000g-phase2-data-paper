...
%
The similarity to \textit{AN. coluzzii} on the X chromosome may be due to selection for the X-linked pink eye mutation in this strain, which originated in the \textit{An. coluzzii} parental strain and thus could have led to the removal of any \textit{An. gambiae} ancestry in this region.
%
