...
%%
(lifted entirely from DK intro) - A major obstacle to malaria elimination is the great capacity of the parasite and vector populations to evolve in response to malaria control interventions. 
%
...
%%
TALK ABOUT RESISTANCE GENERALLY HERE - GET IN MODE??
%%


%%
Currently, most surveillance of insecticide resistance in natural vector populations involves two approaches:
%
...
%
Measuring the insecticide resistance phenotypes of live mosquitoes samples, bred from natural populations provides an almost real-time picture (perhaps just one generation removed) of the strength of resistance.
...
%
However, this approach is laborious, plus it requires expensive environmentally controllable spaces (humidity/temperature/light) to enable mosquito breeding and to ensure repeatability of testing \cite{kleinschmidt2018}.
%%
...
%
These markers also explain just a fraction of the variance in resistance phenotype \cite{donnelly2009, donnelly2016}, for example a combination of three molecular markers were able to explain ~50\% of the variation of resistance to the insecticide DDT \cite{mitchell2014}.
%%
%Translation from development of markers in the lab to field application is compounded by the speeds at which vector insects can adapt in response to insecticides \cite{lynd2010}.



%%
It has become apparent that resistance testing and molecular techniques alone are unable to keep pace of resistance evolution \cite{donnelly2016} and if 
%%
...
%
Analyses reveal the breadth of demography and evolutionary histories now represented in these data and illustrate the power of this genomic resource to inform malaria eradication efforts.
%%
