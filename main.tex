...
%%
Genetic crosses from lab colonies provide a resource for calibration and validation of population genetic analyses.
%
Alongside new wild caught sample genomes, Phase 2 also sees the public release of seven additional lab colony crosses including genomes from both parents and between 14-20 offspring per cross, bringing the total number of available crosses to 11 (Table \ref{table:colony crosses}).
%
Whole genome phasing was also conduced for all samples.. ..@@TODO switch error-rate (issue 153?).
%%
...
%
In Phase 1, just two of the nine populations were \textit{An. coluzzii} and these, Burkina Faso (BFcol) and Angola (AOcol), were highly differentiated with regard to population structure (principal component analysis (PCA), doubleton sharing and F\raisebox{-.4ex}{\scriptsize ST}).
%
...
In a recent study investigating possibilities of gene drive as a means of vector control, a Cas9 target was designed against a 23bp region spanning an intron-exon boundary in the doublesex (\textit{dsx}) gene on chromosome 2R \cite{kyrou2018}.
%
This region was found to contain very little genetic diversity in the Ag1000G Phase 1 samples, perhaps because it is a site of alternative splicing, with the exon being female-specific. 
%
...
%
As was previously found, only one variant site was present within the Cas9 target.
%
The alternative allele at this site was present at 2.9\% frequency in Phase 1, and is now at 2.5\% frequency in Phase 2, being found in \textit{An.coluzzii} from Angola (26.5\% frequency), and \textit{An. gambiae} from Cameroon (1.3\%) and Gabon (5.8\%).
%
This site has previously been shown not to interfere with the gene drive process \cite{kyrou2018}, and as we found no other variant sites, there is no evidence from the 1142 samples in Phase 2 of naturally-occuring variation that could disrupt this gene drive target. 
