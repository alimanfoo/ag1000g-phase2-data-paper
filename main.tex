...
%
Initial groupings (PC1 \textit{vs.} PC1) were quite different when using CNVs, with Angola clustering with the other \textit{An. coluzzii} populations and Kenya clustering with the other two populations with uncertain species assignment (Guinea Bissau and The Gambia). 
%
